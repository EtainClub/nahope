...
export default function GamePage() {
  ...
  const hotspots: Record<RoomId, GameHotspot[]> = {
    OFFICE: [
      {
        id: "bum-seok", name: "Chief Officer Bum-seok", top: "36%", left: "65%", width: "20%", height: "35%",
      ...
      {
        id: "substation-typewriter", name: "Goldstar Retro Typewriter", top: "60%", left: "40%", width: "24%", height: "22%",
      ...
      {
        id: "rotary-phone", name: "Blue House Rotary Phone", top: "68%", left: "71%", width: "18%", height: "22%",
    ...
    <div style={{
      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-2 md:flex-1 md:overflow-hidden md:min-h-0">
          ...
          {/* ── CENTER: Game canvas ─────────────────────────────────────── */}
          <div
            className={`${mobileTab === "canvas" ? "flex" : "hidden"} md:flex flex-col w-full md:flex-1 md:min-w-0 relative`}
          >
            {/* Room nav bar */}
            <div style={{
              display: "flex", justifyContent: "space-between", alignItems: "center",
